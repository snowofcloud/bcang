...
public class PortEnterpriseDataTransformUtils {

    private static PortEnterpriseData ped = new PortEnterpriseData();

    /**查询数据*/
    public static String queryData(JSONObject jsonObject){
        Object mapid1 = jsonObject.get("MAPID");
        String mapid = (String)mapid1;
        return mapid;
    }
