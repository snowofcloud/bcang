...
public class BasicInformationOfShip {
    ...
    private String ZWCM;
    private String YWCM;
    private String CBICKH;
    private String MMSI;
    private String IMO;
    private String HH;
    private String CJGDM;
    private String CQGDM;
    private String HHCBZDM;
    ...
    private String ZCCYWMC;
    private String ZCDD;
    private String ZCDDYWMC;
    private String GJCMC;
    private String GJCYWMC;
    private String GJRQ;
    private String GJDD;
    private String GJDDYWMC;
    private String AFLGRQ;
    private String LGYSZDGD;
    ...
    private String ZCBSL;
    private String JCZDHCDDM;
    private String DSKX;
    private String FDJGL;
    private String GMDSSSBQK;
    ...
    public String getCBICKH() {
        return CBICKH;
    }

    public void setCBICKH(String CBICKH) {
        this.CBICKH = CBICKH;
    }
    ...
    public void setZJZGL(String ZJZGL) {
        this.ZJZGL = ZJZGL;
    }
    ...
    public void setCBZC(String CBZC) {
        this.CBZC = CBZC;
    }
    ...
    public String getLGYSZDGD() {
        return LGYSZDGD;
    }

    public void setLGYSZDGD(String LGYSZDGD) {
    ...
    public void setMZCS(String MZCS) {
        this.MZCS = MZCS;
    }
    ...
    public void setMZPSL(String MZPSL) {
        this.MZPSL = MZPSL;
    }
    ...
    public void setKZPSL(String KZPSL) {
        this.KZPSL = KZPSL;
    }
    ...
    public String getEDXW() {
        return EDXW;
    }

    public void setEDXW(String EDXW) {
        this.EDXW = EDXW;
    }

    public String getEDCW() {
        return EDCW;
    }

    public void setEDCW(String EDCW) {
        this.EDCW = EDCW;
    }
    ...
    public void setCKDEZJ(String CKDEZJ) {
        this.CKDEZJ = CKDEZJ;
    }
    ...
    public String getZCBSL() {
        return ZCBSL;
    }

    public void setZCBSL(String ZCBSL) {
        this.ZCBSL = ZCBSL;
    }
    ...
    public String getGMDSSSBQK() {
        return GMDSSSBQK;
    }

    public void setGMDSSSBQK(String GMDSSSBQK) {
        this.GMDSSSBQK = GMDSSSBQK;
    }
    ...
    public String getSYRFRDB() {
        return SYRFRDB;
    }

    public void setSYRFRDB(String SYRFRDB) {
        this.SYRFRDB = SYRFRDB;
    }
    ...
    public void setJYRFRDB(String JYRFRDB) {
        this.JYRFRDB = JYRFRDB;
    }
    ...
    public void setJYRLXDH(String JYRLXDH) {
        this.JYRLXDH = JYRLXDH;
    }
    ...
    public String getGLRDZ() {
        return GLRDZ;
    }

    public void setGLRDZ(String GLRDZ) {
        this.GLRDZ = GLRDZ;
    }

    public String getGLRFRDB() {
        return GLRFRDB;
    }

    public void setGLRFRDB(String GLRFRDB) {
        this.GLRFRDB = GLRFRDB;
    }
    ...
    public void setCBLXDM(String CBLXDM) {
        this.CBLXDM = CBLXDM;
    }
    ...
    public String getTZPZDW() {
        return TZPZDW;
    }

    public void setTZPZDW(String TZPZDW) {
        this.TZPZDW = TZPZDW;
    }
    ...
    public String getYZCZRJ() {
        return YZCZRJ;
    }

    public void setYZCZRJ(String YZCZRJ) {
        this.YZCZRJ = YZCZRJ;
    }
