package com.c503.sc.jxwl.pipelinemangnt.dao;
...
public interface IPipeLineDao {
     ...
     * @see [类、类#方法、类#成员]
     */
    List<PipeLineStatusEntity> findLiquidSto(Map<String, Object> map)
        throws Exception;
}
