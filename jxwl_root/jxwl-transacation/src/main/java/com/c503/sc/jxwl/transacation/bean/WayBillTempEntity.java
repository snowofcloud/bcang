 ...
 * @since [产品/模块版本]
 */
public class WayBillTempEntity extends BaseEntity {
    
    /** 序列号 */
    private static final long serialVersionUID = 2244391938104436665L;
    ...
    /** 货物信息集合 */
    private List<WayBillGoodsTempEntity> listBillGoodsTemp;
     ...
     * @see [类、类#方法、类#成员]
     */
    public List<WayBillGoodsTempEntity> getListBillGoodsTemp() {
        return listBillGoodsTemp;
    }
     ...
     * 〈功能详细描述〉
     * 
     * @param listBillGoodsTemp listBillGoodsTemp
     * @see [类、类#方法、类#成员]
     */
    public void setListBillGoodsTemp(
        List<WayBillGoodsTempEntity> listBillGoodsTemp) {
        this.listBillGoodsTemp = listBillGoodsTemp;
    }
