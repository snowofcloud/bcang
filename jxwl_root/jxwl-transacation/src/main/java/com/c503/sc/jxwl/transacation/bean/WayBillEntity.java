...
public class WayBillEntity extends BaseEntity {
    ...
    /** 序列号 */
    private static final long serialVersionUID = 2244391938127436665L;
    ...
    /** 企业逻辑删除*/
    private String enterpriseRemove;
    
    
    /** 车辆逻辑删除*/
    private String carRemove;
     ...
     *〈一句话功能简述〉
     * 〈功能详细描述〉
     * @return enterpriseRemove enterpriseRemove
     * @see  [类、类#方法、类#成员]
     */
    public String getEnterpriseRemove() {
        return enterpriseRemove;
    }

    /**
     *〈一句话功能简述〉
     * 〈功能详细描述〉
     * @param enterpriseRemove enterpriseRemove
     * @see  [类、类#方法、类#成员]
     */
    public void setEnterpriseRemove(String enterpriseRemove) {
        this.enterpriseRemove = enterpriseRemove;
    }
     ...
     *〈一句话功能简述〉
     * 〈功能详细描述〉
     * @param carRemove carRemove
     * @see  [类、类#方法、类#成员]
     */
    public void setCarRemove(String carRemove) {
	...
	public String toString() {
		return "WayBillEntity [driverId=" + driverId + ", tempname=" + tempname
				+ ", escortId=" + escortId + ", chemicalId=" + chemicalId
				+ ", logisticsId=" + logisticsId + ", vehicleId=" + vehicleId
				+ ", checkno=" + checkno + ", consumerno=" + consumerno
				+ ", startpoint=" + startpoint + ", startLng=" + startLng
				+ ", startLat=" + startLat + ", endLng=" + endLng + ", endLat="
				+ endLat + ", endpoint=" + endpoint + ", deliveryunit="
				+ deliveryunit + ", deliveryunitperson=" + deliveryunitperson
				+ ", checkstatus=" + checkstatus + ", deliveryunitaddress="
				+ deliveryunitaddress + ", deliveryunittime="
				+ deliveryunittime + ", achieveuint=" + achieveuint
				+ ", achieveperson=" + achieveperson + ", achievephone="
				+ achievephone + ", deliveryunitphone=" + deliveryunitphone
				+ ", achieveaddress=" + achieveaddress + ", achievetime="
				+ achievetime + ", driver=" + driver + ", driverphone="
				+ driverphone + ", driverid=" + driverid + ", driverno="
				+ driverno + ", escort=" + escort + ", escortphone="
				+ escortphone + ", handcarno=" + handcarno + ", escortno="
				+ escortno + ", escortid=" + escortid + ", carno=" + carno
				+ ", remark=" + remark + ", listBillGoods=" + listBillGoods
				+ ", wlEnterpriseName=" + wlEnterpriseName + ", onlineStatus="
				+ onlineStatus + ", goodsname=" + goodsname
				+ ", enterpriseRemove=" + enterpriseRemove + ", carRemove="
				+ carRemove + ", orderNo=" + orderNo + ", vehicleColor="
				+ vehicleColor + "]";
	}
