 ...
 * @since [产品/模块版本]
 */
public class AccountVerifyEntity extends PageForm {
	...
	/** 姓名 */
	@Pattern(regexp = RegexpContant.NAME_REGEXP_MUST, message = "{AccountVerifyEntity.personName}", groups = { Save.class })
