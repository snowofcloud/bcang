 ...
 * @since [产品/模块版本]
 */
@Repository(value = "dangerFileRelaDao")
public interface IDangerFileRelaDao {
    /**
     * 〈一句话功能简述〉
     * 〈功能详细描述〉
     * 
     ...
     * @see [类、类#方法、类#成员]
     */
    int saves(List<DangerFileRelaEntity> list)
        throws Exception;
     ...
     * @throws Exception Exception
     */
    @Select("select tb.file_id from t_danger_vehicle ta "
        + "    join t_danger_file_rela tb on ta.id = tb.danger_vehicle_id"
