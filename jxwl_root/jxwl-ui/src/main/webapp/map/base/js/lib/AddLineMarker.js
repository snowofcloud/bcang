...
*/
HthxMap.AddLineMarker = function(opt_options){
	 var options = opt_options || {};
	  var map = options.map;
	  var displayClass = options.displayClass || "addLineMarker";
	  var target = options.target || "addLineMarker";
	  ...
	  function addInteraction(){
		  ...
		  HthxMap.curMapInteraction = drawLine;
...
ol.inherits(HthxMap.AddLineMarker, ol.control.Control);
