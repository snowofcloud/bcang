...
*/
HthxMap.PlotDoubleArrow = function(opt_options){
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.DOUBLE_ARROW);
	}
...
ol.inherits(HthxMap.PlotDoubleArrow,ol.control.Control);