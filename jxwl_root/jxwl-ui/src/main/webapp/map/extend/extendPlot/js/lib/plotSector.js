...
*/
var map;
HthxMap.PlotSector = function(opt_options){
	...
	button.attributes.className = displayClass || ('plotSector');
	button.title = "扇区";
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.SECTOR);
	}
...
ol.inherits(HthxMap.PlotSector,ol.control.Control);