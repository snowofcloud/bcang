...
*/
HthxMap.PlotCurve = function(opt_options){
	...
	button.attributes.className = displayClass || ('plotCurve');
	button.title = "曲线";
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.CURVE);
	}
...
ol.inherits(HthxMap.PlotCurve,ol.control.Control);