...
*/
HthxMap.PlotClosedCurve = function(opt_options){
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.CLOSED_CURVE);
	}
...
ol.inherits(HthxMap.PlotClosedCurve,ol.control.Control);