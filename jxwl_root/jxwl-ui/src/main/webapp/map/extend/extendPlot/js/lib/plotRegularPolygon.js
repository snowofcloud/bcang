...
*/
HthxMap.PlotRegularPolygon = function(opt_options){
	...
	button.attributes.className = displayClass || ('plotRegularPolygon');
	button.title = "矩形";
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.RegularPolygon);
	}
...
ol.inherits(HthxMap.PlotRegularPolygon,ol.control.Control);