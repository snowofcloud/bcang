...
*/
HthxMap.PlotGatherPlace = function(opt_options){
	...
	button.attributes.className = displayClass || ('plotGatherPlace');
	button.title = "集结地";
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.GATHERING_PLACE);
	}
...
ol.inherits(HthxMap.PlotGatherPlace,ol.control.Control);