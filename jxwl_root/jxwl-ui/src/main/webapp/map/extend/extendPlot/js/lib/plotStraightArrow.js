...
*/
HthxMap.PlotStraightArrow = function(opt_options){
	...
	button.attributes.className = options.displayClass || ("plotStraightArrow"); //必须添加，在查找元素时要用到
	button.title = "细直箭头";
	var element = document.createElement('div');
	element.className = options.displayClass + 'Inactivate ol-unselectable ol-controlPlot';
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.STRAIGHT_ARROW);
	}
...
ol.inherits(HthxMap.PlotStraightArrow, ol.control.Control);