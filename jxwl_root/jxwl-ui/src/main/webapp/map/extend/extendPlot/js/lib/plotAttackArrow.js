...
*/
HthxMap.PlotAttackArrow = function(opt_options){
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.ATTACK_ARROW);
	}
...
ol.inherits(HthxMap.PlotAttackArrow,ol.control.Control);