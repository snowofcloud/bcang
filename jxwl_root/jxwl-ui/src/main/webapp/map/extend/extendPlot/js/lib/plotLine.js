...
*/
HthxMap.PlotLine = function(opt_options){
	...
	button.attributes.className = displayClass || ('plotLine');
	button.title = "直线";
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.Line);
	}
...
ol.inherits(HthxMap.PlotLine,ol.control.Control);