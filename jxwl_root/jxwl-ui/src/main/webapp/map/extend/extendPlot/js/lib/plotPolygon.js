...
*/
HthxMap.PlotPolygon = function(opt_options){
	...
	button.attributes.className = displayClass || ('plotPolygon');
	button.title = "多边形";
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.Polygon);
	}
...
ol.inherits(HthxMap.PlotPolygon,ol.control.Control);