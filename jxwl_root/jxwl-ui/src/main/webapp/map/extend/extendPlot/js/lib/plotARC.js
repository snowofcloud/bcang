...
*/
HthxMap.PlotARC = function(opt_options){
	...
	button.attributes.className = displayClass || ('plotARC');
	button.title = "弧线";
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.ARC);
	}
...
ol.inherits(HthxMap.PlotARC,ol.control.Control);