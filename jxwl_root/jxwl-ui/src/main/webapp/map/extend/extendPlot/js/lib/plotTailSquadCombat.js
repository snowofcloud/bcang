...
*/
HthxMap.PlotTailSquadCombat = function(opt_options){
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.TAILED_SQUAD_COMBAT);
	}
...
ol.inherits(HthxMap.PlotTailSquadCombat,ol.control.Control);