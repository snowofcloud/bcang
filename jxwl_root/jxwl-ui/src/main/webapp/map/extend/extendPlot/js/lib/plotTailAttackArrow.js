...
*/
HthxMap.PlotTailAttackArrow = function(opt_options){
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.TAILED_ATTACK_ARROW);
	}
...
ol.inherits(HthxMap.PlotTailAttackArrow,ol.control.Control);