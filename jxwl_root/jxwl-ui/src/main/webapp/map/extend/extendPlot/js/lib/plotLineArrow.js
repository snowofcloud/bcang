...
*/
HthxMap.PlotLineArrow = function(opt_options){
	...
	function handle(){
		...
		initTargetClass();
		HthxMap.plotObject.activate(plot.PlotTypes.FINE_ARROW);
	}
...
ol.inherits(HthxMap.PlotLineArrow,ol.control.Control);