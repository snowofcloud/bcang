...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.webservices.HelloWorldService {
    ...
    public com.webservices.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public com.webservices.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.webservices.HelloWorldSoapBindingStub _stub = new com.webservices.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.webservices.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.webservices.HelloWorldSoapBindingStub _stub = new com.webservices.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
