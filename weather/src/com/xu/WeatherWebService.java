 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/D:/WeatherWebService.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/WeatherWebService.xml");
